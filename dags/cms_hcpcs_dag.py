...
RUN_EKS = False
AWS_CREDENTIALS_ABSOLUTE_PATH="xxxxxxxxxxxxxxxx"


AIRFLOW_DAGS_PATH = "/opt/airflow/dags"


ATHENA_TABLE_SCHEMA = 'xxxxxx'
ATHENA_TABLE_NAME = 'xxxxx'
ATHENA_TABLE_SCHEMA_MODIFIERS = 'xxxxx'
ATHENA_TABLE_NAME_MODIFIERS = 'xxxxx'
ATHENA_OUTPUT_TABLE_LOCATION = f'xxxxxxxxxxxx{ATHENA_TABLE_SCHEMA}/{ATHENA_TABLE_NAME}/'
ATHENA_OUTPUT_TABLE_LOCATION_MODIFIERS = f'xxxxxxxxxxxxx{ATHENA_TABLE_SCHEMA_MODIFIERS}/{ATHENA_TABLE_NAME_MODIFIERS}/'
ATHENA_QUERY_OUTPUT_LOCATION = 'xxxxxxxxxxxxxxxxxxxxxx'
