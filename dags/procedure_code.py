...
AAPC_SECRET_ID = 'xxxxxxxxxxxxxxxxxxxxxxxxxx'
ATHENA_QUERY_OUTPUT_LOCATION = 'xxxxxxxxxxxxxxxxxxxxxxxxx'

ATHENA_OUTPUT_PROCEDURE_CODES_TABLE_SCHEMA = 'xxxxxxxxxxxxxx'
ATHENA_OUTPUT_PROCEDURE_CODES_TABLE_NAME = 'xxxxxxxxxxxxxxxxxxxxxxxx'
ATHENA_OUTPUT_PROCEDURE_CODES_TABLE_LOCATION = f'xxxxxxxxxxxxxxxxxxxxxxxxxx/{ATHENA_OUTPUT_PROCEDURE_CODES_TABLE_SCHEMA}/{ATHENA_OUTPUT_PROCEDURE_CODES_TABLE_NAME}/'

ATHENA_OUTPUT_PROCEDURE_MODIFIERS_TABLE_SCHEMA = 'xxxxxxxxxxxxxxxxxxxxx'
ATHENA_OUTPUT_PROCEDURE_MODIFIERS_TABLE_NAME = 'xxxxxxxxxxxxxxxxxxxxxxxx'
ATHENA_OUTPUT_PROCEDURE_MODIFIERS_TABLE_LOCATION = f'xxxxxxxxxxxxxxxxxxxxxxxxx/{ATHENA_OUTPUT_PROCEDURE_MODIFIERS_TABLE_SCHEMA}/{ATHENA_OUTPUT_PROCEDURE_MODIFIERS_TABLE_NAME}/'

ATHENA_OUTPUT_PROCEDURE_NDC_TABLE_SCHEMA = 'xxxxxxxxxxxxxxxxxxxxxxxxx'
ATHENA_OUTPUT_PROCEDURE_NDC_TABLE_NAME = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
ATHENA_OUTPUT_PROCEDURE_NDC_TABLE_LOCATION = f'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/{ATHENA_OUTPUT_PROCEDURE_NDC_TABLE_SCHEMA}.{ATHENA_OUTPUT_PROCEDURE_NDC_TABLE_NAME}/'
