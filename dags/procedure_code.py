...
AAPC_SECRET_ID = 'lifemed-data-airflow-eks-projects-crawler'
ATHENA_QUERY_OUTPUT_LOCATION = 's3://claims-management-athena-results/ClaimsManagementDataCatalog/'

ATHENA_OUTPUT_PROCEDURE_CODES_TABLE_SCHEMA = 'temp_db'
ATHENA_OUTPUT_PROCEDURE_CODES_TABLE_NAME = 'procedure_codes_v2'
ATHENA_OUTPUT_PROCEDURE_CODES_TABLE_LOCATION = f's3://claims-management-data-lake/warehouse/{ATHENA_OUTPUT_PROCEDURE_CODES_TABLE_SCHEMA}/{ATHENA_OUTPUT_PROCEDURE_CODES_TABLE_NAME}/'

ATHENA_OUTPUT_PROCEDURE_MODIFIERS_TABLE_SCHEMA = 'temp_db'
ATHENA_OUTPUT_PROCEDURE_MODIFIERS_TABLE_NAME = 'procedure_codes_modifiers'
ATHENA_OUTPUT_PROCEDURE_MODIFIERS_TABLE_LOCATION = f's3://claims-management-data-lake/warehouse/{ATHENA_OUTPUT_PROCEDURE_MODIFIERS_TABLE_SCHEMA}/{ATHENA_OUTPUT_PROCEDURE_MODIFIERS_TABLE_NAME}/'

ATHENA_OUTPUT_PROCEDURE_NDC_TABLE_SCHEMA = 'temp_db'
ATHENA_OUTPUT_PROCEDURE_NDC_TABLE_NAME = 'procedure_codes_ndc'
ATHENA_OUTPUT_PROCEDURE_NDC_TABLE_LOCATION = f's3://claims-management-data-lake/warehouse/{ATHENA_OUTPUT_PROCEDURE_NDC_TABLE_SCHEMA}.{ATHENA_OUTPUT_PROCEDURE_NDC_TABLE_NAME}/'
